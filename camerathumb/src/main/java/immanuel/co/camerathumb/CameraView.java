...
public class CameraView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    private static final String LOG_TAG = "Camera View";
    ...
    public interface CamaraViewListener{
        public void onImageCaptures(Bitmap img);
    }
    CamaraViewListener listener = null;
    public void setCamaraViewListener(CamaraViewListener listener) {
    ...
    public CameraView(AppCompatActivity activity, int cameraId, LayoutMode mode) {
    ...
    Camera.PictureCallback myPictureCallback_JPG = new Camera.PictureCallback(){
        ...
        public void onPictureTaken(byte[] arg0, Camera arg1) {
            ...
            if (listener != null){
                listener.onImageCaptures(bitmap);
            }
